...
<body>
    ...
    <header class="">
        <nav class="flex items-center justify-start flex-row bg-white drop-shadow-md md:shadow-indigo-500/40">
            ...
            <button type="submit"
                class="block mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold " data-modal-toggle="authentication-modal"> 
                Editar Evento
            </button>
                                    ...
                                    <div class="w-full lg:w-6/12 px-4">
                                        <div class="relative w-full mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                placeholder="300" value="{{ $eventos->capacidadeMaxima }}" name="capacidadeMaxima">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-wrap">
                                    <div class="w-full lg:w-12/12 px-4">
                                        <div class="relative w-full mb-3">
                                            <input type="text"
                                                class="w-full px-3 py-3 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                                placeholder="Bld Mihail Kogalniceanu, nr. 8 Bl 1, Sc 1, Ap 09" value="{{$eventos->endereco}}" name="endereco">
                                        </div>
                                    </div>
                                </div>
                                <hr class="mt-6 border-b-1 border-blueGray-300">
...
<div >
    <div class="mt-5 flex justify-center">
        <h1 class="flex items-center text-5xl font-extrabold dark:text-white">{{$eventos->nome}}</h1>
    </div>

    <div class=" m-10 mt-10">
        <h2 class="text-4xl font-bold dark:text-white">Descrição do evento</h2>
    </div>
    <div class="m-10 mt-10">
        <p class="text-xl font-bold dark:text-white">{{$eventos->descricao}}</p>
    </div>
<hr class="mt-6 border-b-1 border-blueGray-300">
    <div class="m-10 mt-10">
        <h2 class="text-4xl font-bold dark:text-white">Endereço do Evento</h2>
        <div class="m-10 mt-10">
            <p class="text-xl font-bold dark:text-white">{{$eventos->endereco}}</p>
        </div>
    </div>

    <div class="m-10 mt-10">
        <h2 class="text-4xl font-bold dark:text-white">Capacidade Máxima</h2>
        <div class="m-10 mt-10">
            <span><p class="text-xl font-bold dark:text-white">{{$eventos->capacidadeMaxima}}</p></span>
        </div>
    </div>
</div>
