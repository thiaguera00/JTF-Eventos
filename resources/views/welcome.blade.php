                ...
                <div class="flex -mx-3">
                    <div class="w-1/2 px-3 mb-5">
                        ...
                        <div class="flex">
                            ...
                            <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John" name="nome">
                        </div>
                    </div>
                    <div class="w-1/2 px-3 mb-5">
                        ...
                        <div class="flex">
                            ...
                            <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="000.000.000-00" name="cpf">
                        </div>
                    </div>
                </div>
                    <div class="w-1/2 px-3 mb-5">
                        ...
                        <div class="flex">
                            ...
                            <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="(00) 0 0000-0000" name="telefone">
                        </div>
                    </div>
                </div>
